...
const WhatsAppButton = () => {
  ...
  const whatsappNumber = "5531991931283"; // Número do Ondir
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      {/* Popup */}
      <div
        className={`absolute bottom-20 right-0 w-80 bg-white rounded-3xl shadow-2xl overflow-hidden transition-all duration-500 origin-bottom-right ${isOpen
      ...
      <button
        ...
        className={`relative w-16 h-16 bg-gradient-to-br from-primary to-brand-700 rounded-full flex items-center justify-center shadow-lg shadow-primary/40 transition-all duration-500 ${isOpen
            ? "rotate-0 scale-90"
            : "rotate-0 scale-100 hover:scale-110 hover:shadow-xl hover:shadow-primary/50"
          }`}
      >
