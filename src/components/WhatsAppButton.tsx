  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      ...
      <button
        ...
        className={`relative w-16 h-16 bg-gradient-to-br from-primary to-brand-700 rounded-full flex items-center justify-center shadow-lg shadow-primary/40 transition-all duration-500 ${
          isOpen 
            ? "rotate-0 scale-90" 
