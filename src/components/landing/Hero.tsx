      ...
      <div className="container relative pt-24 pb-0 md:pt-32 md:pb-0 px-4">
        ...
        <div className="relative flex justify-center animate-fade-up mt-6 md:mt-10" style={{ animationDelay: "0.4s" }}>
          <div className="relative max-w-[900px] w-full flex justify-center">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[350px] md:w-[400px] h-[600px] md:h-[700px] bg-gradient-to-br from-white/10 to-white/5 rounded-full blur-3xl" />

            {/* Phone Mockup - Using the uploaded mockup with built-in frame */}
            <div className="relative w-[320px] sm:w-[340px] md:w-[380px] lg:w-[420px] mx-auto transform hover:scale-[1.02] transition-transform duration-500 z-10">
              <img
                src={appMockup}
